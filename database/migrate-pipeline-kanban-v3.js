/**
 * Pipeline Kanban v3  9 colunas (iPad): Novo lead ? Perdido.
...
const KANBAN_STAGES = [
  ...
  { slug: 'quote_sent', name: 'Oramento enviado', order_num: 4, color: '#9b59b6', is_closed: 0 },
...
async function main() {
  ...
  try {
    ...
    await conn.commit();
    console.log('OK — estágios atualizados e leads migrados.');
